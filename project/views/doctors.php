...
// $sql_d = "SELECT * from doctors INNER JOIN major on major.id=doctors.major_id";
// $data_d = getAll($sql_d);
$data = getAll($sql);

// $query = "SELECT * FROM `clinic`.`major` WHERE `id` =" . $_GET['id'];
// $data_q = getAll($query);
...
<div class="container">
    ...
    <div class="filteration d-flex gap-3 mb-3 flex-wrap justify-content-center justify-content-lg-start justify-content-md-start">
        <div class="dropdown">
            <button class="btn bg-blue btn-primary align-items-center d-flex gap-2 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                governorate
            </button>
