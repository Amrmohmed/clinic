                ...
                <div class="splide__track ">
                    <ul class="splide__list">
                        <li class="splide__slide">
                            <?php foreach ($data_d as  $value) { ?>
                                <div class="card p-2" style="width: 18rem;">
                                    <img src="../../assets/images/<?php echo $value['image'] ?>" class="" alt="major">
                                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                        <h4 class="card-title fw-bold text-center"><?php echo $value['name'] ?></h4>
                                        <h6 class="card-title fw-bold text-center"><?php echo $value['major_id'] ?></h6>
